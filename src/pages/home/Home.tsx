    ...
    <>
      <main className="relative w-full min-h-screen pt-20 md:pt-24">
        <div
          ...
          style={{ backgroundImage: `url(${fotofood})` }}
          role="img"
        ...
        <section className="relative z-10 flex items-start pt-24 md:pt-32 lg:pt-40 px-6 sm:px-10 md:px-16 lg:px-24">
          <div className="max-w-4xl text-white">
            <span className="inline-block font-inter text-xl sm:text-2xl tracking-wide text-amber-100 animate-fade-in">
              Nutrição Simples e Pura
            </span>

            <h1 className="mt-5 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-sansita leading-tight sm:leading-[1.1]">
            ...
            <div className="mt-9 md:mt-11 flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
              ...
              <button
                ...
                className="w-full sm:w-auto font-inter font-semibold text-lg md:text-xl lg:text-2xl
                  flex items-center gap-2 text-[#E9BD8C] hover:text-[#F8D4AC]
                  transition-all duration-300 group rounded-md px-5 py-3.5
                  focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-2 focus:ring-offset-black"
              >
                Saiba Mais
      ...
      <section
        ...
        aria-label="Seção de receitas saudáveis"
      >
        <Receitas />
      </section>
      <section>
